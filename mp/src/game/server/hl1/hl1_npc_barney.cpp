...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CNPC_Barney_HL1 )
...
LINK_ENTITY_TO_CLASS( monster_barney, CNPC_Barney_HL1 );
...
void CNPC_Barney_HL1::Spawn()
{
	...
	SetUse( &CNPC_Barney_HL1::FollowerUse );
}

//=========================================================
// Precache - precaches all resources this monster needs
//=========================================================
void CNPC_Barney_HL1::Precache()
{
...
void CNPC_Barney_HL1::ModifyOrAppendCriteria( AI_CriteriaSet& criteriaSet )
{
...
//=========================================================
int CNPC_Barney_HL1::GetSoundInterests ( void) 
{
	return	SOUND_WORLD	|
			SOUND_COMBAT	|
			SOUND_CARCASS	|
...
// relationship table.
//=========================================================
Class_T	CNPC_Barney_HL1::Classify ( void )
{
...
//=========================================================
void CNPC_Barney_HL1::AlertSound( void )
{
	if ( GetEnemy() != NULL )
	{
		if ( IsOkToSpeak() )
...
//=========================================================
void CNPC_Barney_HL1::SetYawSpeed ( void )
{
	int ys;
...
// CheckRangeAttack1
//=========================================================
bool CNPC_Barney_HL1::CheckRangeAttack1 ( float flDot, float flDist )
{
...
// Output  :
//------------------------------------------------------------------------------
int CNPC_Barney_HL1::RangeAttack1Conditions( float flDot, float flDist )
{
	if (GetEnemy() == NULL)
	{
		return( COND_NONE );
...
//=========================================================
void CNPC_Barney_HL1::BarneyFirePistol ( void )
{
...
int CNPC_Barney_HL1::OnTakeDamage_Alive( const CTakeDamageInfo &inputInfo )
{
...
// PainSound
//=========================================================
void CNPC_Barney_HL1::PainSound( const CTakeDamageInfo &info )
{
...
// DeathSound 
//=========================================================
void CNPC_Barney_HL1::DeathSound( const CTakeDamageInfo &info )
{
	CPASAttenuationFilter filter( this );
...
void CNPC_Barney_HL1::TraceAttack( const CTakeDamageInfo &inputInfo, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator )
{
...
void CNPC_Barney_HL1::Event_Killed( const CTakeDamageInfo &info )
{
...
void CNPC_Barney_HL1::SUB_StartLVFadeOut( float delay, bool notSolid )
{
	SetThink( &CNPC_Barney_HL1::SUB_LVFadeOut );
...
void CNPC_Barney_HL1::SUB_LVFadeOut( void  )
{
...
void CNPC_Barney_HL1::StartTask( const Task_t *pTask )
{
	BaseClass::StartTask( pTask );	
}

void CNPC_Barney_HL1::RunTask( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
...
//=========================================================
void CNPC_Barney_HL1::HandleAnimEvent( animevent_t *pEvent )
{
	switch( pEvent->event )
	{
...
int CNPC_Barney_HL1::TranslateSchedule( int scheduleType )
{
	switch( scheduleType )
	{
...
// of the proper type.
//=========================================================
int CNPC_Barney_HL1::SelectSchedule( void )
{
...
NPC_STATE CNPC_Barney_HL1::SelectIdealState ( void )
{
	return BaseClass::SelectIdealState();
}

void CNPC_Barney_HL1::DeclineFollowing( void )
{
...
bool CNPC_Barney_HL1::CanBecomeRagdoll( void )
{
	if ( UTIL_IsLowViolence() )
	{
		return false;
...
bool CNPC_Barney_HL1::ShouldGib( const CTakeDamageInfo &info )
{
	if ( UTIL_IsLowViolence() )
	{
		return false;
...
AI_BEGIN_CUSTOM_NPC( monster_barney, CNPC_Barney_HL1 )
